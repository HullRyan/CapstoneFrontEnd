			...
			<div className="container">
				...
				<div className="team">
					...
					<div className="team-member">
						...
						></Image>
						<div>
							<strong>Murtadha Marzouq (Abu)</strong> is an IT specialist with
							over 8 years of experience in IT infrastructure and networking.
							Murtadha graduated from Central Piedmont College and is currently
							a student at The University of North Carolina in Charlotte.
							Murtadha provides IT support for our clients in Charlotte, NC. He
							is experienced in setting up IT infrastructure from Cisco
							networking to Active Directory. He also has experience in Linux
							and setting up Linux-based services such as Secure FTP, MySQL and
					...
					<div className="team-member">
						...
						></Image>
						<div>
							<strong>Seth Adams</strong> has been studying IT for over 6 years
							from late high school to the present. Seth is working towards his
							degree in Computer Science with a concentration in Software,
							Systems & Networks. He started his studies at Rowan-Cabarrus
							Community College and transferred to UNCC last year. His
							experience in computer science includes not only his work at the
							university, but also a summer internship at TIAA over last summer.
							Seth was born and raised in San Antonio, Texas and has been living
							in Charlotte, North Carolina for 8 years.
						</div>
					</div>
					...
					<div className="team-member">
						...
						<div>
							...
							University of North Carolina at Charlotte (UNCC) for the last two
							years of his degree. He majors in Computer Science with a
					...
					<div className="team-member">
						...
						<div>
							...
							I&apos;ve done are graduated from Catawba Valley Community College
							with an associate degree. I have six years of experience working
							in customer service. Over the years, I have improved my
